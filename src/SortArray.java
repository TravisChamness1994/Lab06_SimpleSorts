...
public class SortArray
{
    ...
    void shellSortWithNoEvenStep(T[] a, int first, int last)
    {
        ...
        {
            //TODO Project1 C - ImprovedShellSort - Done
    ...
    void improvedBubbleSort(T[] a)
    {
        ...
        //TODO Project1 D - Improved Bubble - Done
        //TODO Project1 F - Improved Bubble - Done
        int leftIndex = 0;
    ...
    void shakerImprovedBubbleSort(T[] a)
    {
        ...
        //TODO Project1 E - Shaker Sort - Done
        //TODO Project1 F - Shaker Sort - Done
        int leftIndex = 0;
        int rightIndex = a.length - 1;
        int lastSwap;
    ...
    private static void runStatistics(Integer dataOriginal[])
    {
        ...
        {
            System.out.println("\n\u001B[35m\u001B[1m*** ANALYZING " + SORT_NAMES[sort] + " SORT ***\u001B[29m");
    ...
    {
        //TODO Project1 A - ReverseOrder - Done
        if(data.length > 1)
        {
    ...
    private static Integer[] generateRandomArray(int size)
    {
        ...
        //TODO Project1 A - RandomArray - Done
